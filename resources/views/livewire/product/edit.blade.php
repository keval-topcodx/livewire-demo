    ...
    <form class="form" wire:submit="submit">
        ...
        <div class="mt-3">
            ...
            <div class="image-select border p-4 text-center bg-light" style="cursor: pointer;"
                ...
                @if($existingImages)
                    <p class="mt-3"><strong>Existing Images:</strong></p>
                    <div class="mt-3 d-flex gap-3 flex-wrap">
                        @foreach($existingImages as $media)
                            <img src="{{ $media->getUrl() }}" class="img-thumbnail" style="max-width: 150px;" alt="Image">
                        @endforeach
                    </div>
                @endif
                @if($images)
                    <p class="mt-3"><strong>New Uploads:</strong></p>
                    <div class="mt-3 d-flex gap-3 flex-wrap">
